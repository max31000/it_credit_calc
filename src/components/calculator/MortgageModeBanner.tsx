...
const ASSUMPTIONS_TEXT =
  'Срок округляется до целых лет, поэтому расчётный платёж не совпадает с фактическим на ' +
  'несколько сотен рублей — фактический платёж трекера показан рядом для сравнения. ' +
  'Прошлое до «сегодня» восстановлено по корректировкам трекера.'
