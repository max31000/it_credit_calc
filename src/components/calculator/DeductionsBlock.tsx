    ...
    <Stack gap="sm">
      ...
      <Stack gap={4}>
        <Group gap={4} align="center">
          ...
          <InfoTooltip text="Вычет по уплаченным ипотечным процентам: база до 3 млн ₽ за всё время кредита. В режиме ипотеки удобнее указывать его через форму ипотеки — там есть помощник «по какой год получен»." />
        </Group>
        <NumericInput
